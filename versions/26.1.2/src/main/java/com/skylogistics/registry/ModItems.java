...
public final class ModItems {
    ...
    public static final DeferredHolder<Item, BlockItem> SIMPLE_FLUID_PIPE = ITEMS.register("simple_fluid_pipe",
            () -> new BlockItem(ModBlocks.SIMPLE_FLUID_PIPE.get(), blockItemProperties("simple_fluid_pipe")));
    public static final DeferredHolder<Item, BlockItem> SIMPLE_ENERGY_PIPE = ITEMS.register("simple_energy_pipe",
            () -> new BlockItem(ModBlocks.SIMPLE_ENERGY_PIPE.get(), blockItemProperties("simple_energy_pipe")));
    ...
    public static final DeferredHolder<Item, UpgradeCardItem> FORCE_EXTRACTION_UPGRADE = ITEMS.register("force_extraction_upgrade",
            () -> new UpgradeCardItem(itemProperties("force_extraction_upgrade").stacksTo(64),
    ...
    public static final DeferredHolder<Item, UpgradeCardItem> ORDERED_MATCHING_UPGRADE = ITEMS.register("ordered_matching_upgrade",
            () -> new UpgradeCardItem(itemProperties("ordered_matching_upgrade").stacksTo(64),
    ...
    public static final DeferredHolder<Item, ChoraNectarItem> CHORA_NECTAR = ITEMS.register("chora_nectar",
            () -> new ChoraNectarItem(itemProperties("chora_nectar").fireResistant()));
