...
<ItemLink id="eulogia_crystal" /> 刚合成出来时还没有充能。把它带到足够高的地方就会开始吸收星辉；默认高度是 Y=200，服务器设置可能有所不同。

<RecipeFor id="eulogia_crystal" fallbackText="未找到尤洛伽水晶配方。" />

尤洛伽水晶以钻石为核心，不消耗末影珍珠。刚合成出的水晶尚未充能。

未充能水晶放在玩家背包里就能充能，也可以放在 <ItemLink id="offering_table" /> 上等待充能。普通箱子不会充能水晶。默认充能时间约为 60 秒，服务器设置可能有所不同。
