...
public final class ModMenus {
    ...
    public static final RegistryObject<MenuType<KleisDominionWandMenu>> KLEIS_DOMINION_WAND =
            MENUS.register("kleis_dominion_wand", () -> IForgeMenuType.create((id, inventory, buffer) ->
