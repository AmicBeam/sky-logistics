...
public final class ModItems {
    ...
    public static final RegistryObject<Item> SKY_DISTRIBUTOR = ITEMS.register("sky_distributor",
            () -> new BlockItem(ModBlocks.SKY_DISTRIBUTOR.get(), new Item.Properties()));
    ...
    public static final Optional<RegistryObject<Item>> SKY_WRENCH = registerSkyWrench();
    ...
    public static final Optional<RegistryObject<Item>> FORCE_EXTRACTION_UPGRADE = registerForceExtractionUpgrade();
    ...
    private static Optional<RegistryObject<Item>> registerSkyWrench() {
    ...
    private static Optional<RegistryObject<Item>> registerForceExtractionUpgrade() {
