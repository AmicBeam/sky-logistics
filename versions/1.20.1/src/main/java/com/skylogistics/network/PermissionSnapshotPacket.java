...
public record PermissionSnapshotPacket(int containerId, boolean publicAccess, String query, int page, int total, List<Entry> entries) {
    ...
    public static void handle(PermissionSnapshotPacket packet, Supplier<NetworkEvent.Context> supplier) {
