...
public final class SkyLogisticsConfig {
    ...
    public static final class Server {
        ...
        private Server(ForgeConfigSpec.Builder builder) {
            ...
            enableMaintainedSoulPolling = builder.comment("Enable maintained Souls source recovery polling when supported.", "在版本支持时启用 Souls 维持缺口的来源恢复探测。").define("enableMaintainedSoulPolling", true);
