...
public final class SkyNodeJadeProvider extends BaseSkyLogisticsJadeProvider
    ...
    private static CompoundTag writeNodeData(SkyNodeBlockEntity node) {
        ...
        data.put("ProgressionRate", JadeTransferRateTooltip.write(node, node.getTargetDirection()));
    ...
    private static void appendNodeTooltip(ITooltip tooltip, CompoundTag data, net.minecraft.world.entity.player.Player player) {
        ...
        tooltip.add(Component.translatable("jade.skylogistics.resources",
                resourceSummary(data.getBoolean("Items"), data.getBoolean("Fluids"), data.getBoolean("Energy"))));
        tooltip.add(Component.translatable("jade.skylogistics.upgrades",
                upgradeSummary(data.getBoolean("SpeedUpgrade"), data.getBoolean("DimensionUpgrade"),
                        data.getBoolean("ForceExtractionUpgrade"))));
        ...
        JadeTransferRateTooltip.append(tooltip, data.getCompound("ProgressionRate"));
