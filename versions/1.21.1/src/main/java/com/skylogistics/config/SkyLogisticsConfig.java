...
public final class SkyLogisticsConfig {
    ...
    private static List<? extends Object> defaultAdvancementRates() {
        return List.of(
                advancementRate("minecraft:story/smelt_iron", "minecraft:iron_ingot",
                        "advancements.story.smelt_iron.title", "task", 16L, 2_500L, 2_500L, 2_500L,
                        25_000L, 13L, 13L),
                advancementRate("minecraft:story/mine_diamond", "minecraft:diamond",
                        "advancements.story.mine_diamond.title", "task", 64L, 10_000L, 10_000L, 10_000L,
                        100_000L, 50L, 50L),
                advancementRate("minecraft:story/enchant_item", "minecraft:enchanting_table",
                        "advancements.story.enchant_item.title", "task", 1_024L, 160_000L, 160_000L, 160_000L,
                ...
                advancementRate("minecraft:adventure/trade_at_world_height", "minecraft:emerald",
                        ...
                        5_120_000L, 5_120_000L, 51_200_000L, 25_600L, 25_600L),
                advancementRate("minecraft:nether/create_beacon", "minecraft:beacon",
                        ...
                        163_840_000L, 163_840_000L, 1_638_400_000L, 819_200L, 819_200L),
                advancementRate("minecraft:nether/create_full_beacon", "minecraft:beacon",
                        ...
                        2_147_483_647L, 2_147_483_647L),
                advancementRate("minecraft:end/elytra", "minecraft:elytra", "advancements.end.elytra.title",
                        "goal", "unlimited", "unlimited", "unlimited", "unlimited", "unlimited", "unlimited", "unlimited"));
    }
    ...
    public static final class Server {
        ...
        public final ModConfigSpec.BooleanValue enableKleisDominionWandEntityTeleport;
        public final ModConfigSpec.IntValue kleisDominionWandTeleportY;
        ...
        public final ModConfigSpec.IntValue distributorIndexingRetryTicks;
