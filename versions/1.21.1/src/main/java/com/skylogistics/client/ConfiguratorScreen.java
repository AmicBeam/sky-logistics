...
public class ConfiguratorScreen extends AbstractContainerScreen<ConfiguratorMenu> {
    ...
    private void renderDetailHeader(GuiGraphics graphics) {
        ...
        graphics.drawCenteredString(font, Component.translatable("screen.skylogistics.detail.mode"), DETAIL_X + 38, y, ConfigPanel.MUTED);
        graphics.drawCenteredString(font, Component.translatable("screen.skylogistics.detail.resources"), DETAIL_X + 72, y, ConfigPanel.MUTED);
