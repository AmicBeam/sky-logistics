...
public final class KleisDominionWandScreen extends AbstractContainerScreen<KleisDominionWandMenu> {
    public KleisDominionWandScreen(KleisDominionWandMenu menu, Inventory inventory, Component title) {
        ...
        imageWidth = 240; imageHeight = 184; inventoryLabelY = 91;
    }
    ...
    @Override protected void renderLabels(GuiGraphics g, int mx, int my) {
        g.drawString(font, title, 8, 7, 0xE8F7FF, false);
        g.drawString(font, Component.translatable("screen.skylogistics.kleis.line", menu.lineName()), 14, 27, 0xB9FFF4, false);
        g.drawString(font, Component.translatable("screen.skylogistics.kleis.mode",
                Component.translatable("tooltip.skylogistics.face_mode." + menu.mode().getSerializedName())), 14, 41, 0xFFD56F, false);
        g.drawString(font, Component.translatable("screen.skylogistics.kleis.target", menu.pos().toShortString(), menu.face().getName()), 14, 55, 0xD0D8E0, false);
        g.drawString(font, Component.translatable("screen.skylogistics.kleis.cross_dimension"), 14, 69, 0xD9A8FF, false);
        g.drawString(font, playerInventoryTitle, 39, inventoryLabelY, 0xD0D8E0, false);
    }
